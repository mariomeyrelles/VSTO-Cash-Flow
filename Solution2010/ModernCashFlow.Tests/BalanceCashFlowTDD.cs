...
namespace ModernCashFlow.Tests
{
    public class BalanceCashFlowTDD
    {
        ...
        public void Can_calculate_simple_balance()
        {
            ...
            var calculationArgs = new CalculationArgs(1, incomes, expenses);
        ...
        public void Can_calculate_balance_with_initial_balance()
        {
            ...
            var balanceService = new BalanceCalculationService();
            var calculationArgs = new CalculationArgs(1, incomes, expenses){InitialBalance = initialBalance};
            var balance = balanceService.CalculateSimpleBalance(calculationArgs);
        ...
        public void Can_calcultate_balance_up_to_given_date()
        {
            ...
            var balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1,incomes,expenses){EndingDate = new DateTime(2011, 01, 31)});
            Console.WriteLine("balance (before january): " + balance);
            Assert.IsTrue(balance == 0);

            balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { EndingDate = new DateTime(2012, 01, 31) });
            Console.WriteLine("balance (end of january): " + balance);
            Assert.IsTrue(balance == -99.9m);
            
            balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { EndingDate = new DateTime(2012, 02, 28) });
            Console.WriteLine("balance (end of february): " + balance);
            Assert.IsTrue(balance == -300.00m);

            balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { EndingDate = new DateTime(2012, 03, 01) });
            Console.WriteLine("balance (begining of march): " + balance);
            Assert.IsTrue(balance == 1200.00m);
            
            balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { EndingDate = new DateTime(2012, 03, 15) });
            Console.WriteLine("balance (middle of march): " + balance);
            Assert.IsTrue(balance == 69.79m);
            
            balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { EndingDate = new DateTime(2012, 05, 15) });
            Console.WriteLine("balance (middle of may): " + balance);
            Assert.IsTrue(balance == 669.64m);
            
            balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { EndingDate = new DateTime(2013, 01, 01) });
        ...
        public void Can_calcultate_balance_up_to_given_date_and_time_ignoring_times()
        {
            ...
            var balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { EndingDate = new DateTime(2011, 01, 01) });
            Console.WriteLine("balance (at 00:00): " + balance);
            Assert.IsTrue(balance == 0);


            balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { EndingDate = new DateTime(2011, 01, 01, 08, 01, 0) });
            Console.WriteLine("balance (at 08:01): " + balance);
            Assert.IsTrue(balance == 0);
            
            balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { EndingDate = new DateTime(2013, 01, 01, 09, 0, 0) });
            Console.WriteLine("balance (at 09:00): " + balance);
            Assert.IsTrue(balance == 0);


            balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { EndingDate = new DateTime(2013, 01, 01, 12, 0, 0) });
        ...
        public void Can_calcultate_balance_as_of_given_date()
        {
            ...
            var balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses) { StartingDate = new DateTime(2013, 01, 31) });
        ...
        public void Can_calcultate_balance_of_a_given_date_interval()
        {
            ...
            var balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses)
                                                                    {
            ...
            balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, expenses)
            {
                StartingDate = new DateTime(2012, 03, 1),
        ...
        public void Can_calculate_balance_using_only_incomes()
        {
            ...
            var balance = balanceService.CalculateSimpleBalance(new CalculationArgs(1, incomes, null)
            {
                StartingDate = new DateTime(2012, 03, 1),
                EndingDate = new DateTime(2012, 03, 31),
                InitialBalance = 717.12m
        ...
        public void Can_calculate_simple_cashflow_for_one_account()
        {
            ...
            var cashflow = service.CalculateCashflow(new CalculationArgs(1,incomes, expenses)
            {
